...
\begin{frame}{Démos}
  ...
  \item Capture HTTPS + get sur PCAP + déchiffrement?\\[.5cm]
  \item Truc graphique à base de JSON?
  \end{itemize}
\end{frame}
...
\begin{frame}{Installation de Parsifal}
  \vspace{18mm}

  \begin{block}
    \begin{tabular}{>{\tt}l}
      \verb+wget http://paperstreet.picty.org/parsifal/parsifal-0.2-rc.tar.gz+ \\
...
% Ecriture pas-à-pas d'un novueau format (TAR ou PCAP)
...
% Feuille de route (TODO) / Desideratas pour la suite
