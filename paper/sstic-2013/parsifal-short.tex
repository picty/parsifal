...
de nouveaux formats de fichiers et protocoles: DNS, OCSP, etc.

Enfin, \Parsifal sert aussi de base à des outils d'analyse de
certificats et de connexions TLS, qui font aussi l'objet d'un
développement actif.
