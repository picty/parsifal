...
let pstate = pstate_of_string "ClientHello_openssl" record_string;;

try
  let record = parse_record true pstate in
...
let pstate = pstate_of_string  "Server answer" server_answer;;
