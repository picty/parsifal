...
let asn1_ehf = (Asn1.Engine.default_error_handling_function 4 0)
...
let pstate = pstate_of_string (default_error_handling_function 2 0) "Server answer" server_answer;;
