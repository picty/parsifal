...
\author{
  \begin{tabular}{c}
    Olivier Levillain\wu\wg, \qquad Hervé Debar\wg and \qquad Benjamin Morin\wu \\[3mm]
    \footnotesize
    \begin{tabular}{ccc}
...
can be very tricky to implement: for example, the Wireshark project
...
will then be used to begin a PNG sanitizer. Alternatively, an X.509
certificate signing request validator can be implemented.
...
Our first attempt to write an SSL parser was in Python; it was
...
overall tutorial was given over a 3-hour session. All the material
(this short paper, the slides and the code snippets) will be available
...
Another format worth implementing is X.509 Certificate Signing
