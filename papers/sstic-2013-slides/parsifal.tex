...
\title[\url{https://github.com/ANSSI-FR/parsifal}]{Parsifal, ou comment écrire rapidement des \emph{parsers}
...
\begin{frame}{Outils existants pour analyser des formats binaires}
  ...
  \item Avantages
    ...
    \item de nombreux protocoles réseau et formats de fichiers déjà implémentés
    \item Scapy (et Hachoir) facilement extensible\\[.5cm]
    \end{itemize}

  \item Limitations
    \begin{itemize}
    \item deux outils sont limités au réseau
...
\begin{frame}{Historique des outils}
  ...
  \item OCaml avec un préprocesseur: tous les indicateurs au vert
  \end{itemize}
\end{frame}
